...
<head>
    <meta charset="UTF-8">
    <title><?php echo $fetch_info['name'] ?> | Expenses</title>
            ...
            <div class="col-3">
                <div class="card border-danger mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body text-danger">
                        ...
                        <p class="card-text display-4 text-dark">₹70000</p>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card border-primary mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body text-primary">
                        ...
                        <p class="card-text display-4 text-dark">₹114000</p>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card border-info mb-3" style="max-width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text display-4 text-dark">₹850000</p>
                    </div>
                </div>
            </div>
            <div class="col-3">
            ...
            <div class="container">
                <form>
                    ...
                    <div class="form-group row d-flex">
                        <button type="submit" class="btn btn-success" style="width: 70px">Save</button>
        ...
        <div class="modal-body">
            <div class="container">
                <form>
                    ...
                    <div class="form-group row d-flex">
                        <button type="submit" class="btn btn-success" style="width: 130px">Save Changes</button>
                        <button type="button" class="btn btn-secondary ms-2" style="width: 70px" data-bs-dismiss="modal">Close</button>
                    </div>
                </form>
            </div>
...
<div class="modal fade" id="delete" tabindex="-1" role="dialog" aria-labelledby="deleteLabel" aria-hidden="true">
    ...
    <script>
        ...
        const myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Rent', 'Groceries', 'Domestic Help', 'Bills', 'Insurance', 'Others'],
                datasets: [{
